...
export const  BOOK_REMOVE_FAIL = 'BOOK_REMOVE_FAIL'
...
export const  BOOK_NEW_REVIEW_REQUEST = 'BOOK_NEW_REVIEW_REQUEST'
export const  BOOK_NEW_REVIEW_SUCCESS = 'BOOK_NEW_REVIEW_SUCCESS'
export const  BOOK_NEW_REVIEW_FAIL = 'BOOK_NEW_REVIEW_FAIL'
export const  BOOK_NEW_REVIEW_RESET = 'BOOK_NEW_REVIEW_RESET'